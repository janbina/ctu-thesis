...
\enditems
This means that to maximize and minimize the window, as well as to do many more actions, the user can use sxhkd in combination
with xdotool or wmctrl and swm does not have to be involved at all (apart from implementing the EWMH protocol).
