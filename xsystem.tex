...
Table~\ref[tab:properties] shows some of the properties retrieved from
...
\heading Comparison
In Listings~\ref[code:xlib] and~\ref[code:xcb], we can see comparison of those two libraries on the task of looking up a window property.
