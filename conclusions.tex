...
It was designed and implemented in a way to be built upon, to be extended with new functionalities, and adapted to various use cases and user preferences.
Therefore, there is a potential for it to be extended by third parties, either in a way of contributions or by starting a new
