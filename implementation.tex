...
Firstly, we will go through the tools used for the implementation, as well as for testing and communication with the window manager.
Then, we will discuss the implementation and testing process.
Lastly, we will look on code management, publish and continuous integration.
...
In this section, we will describe some tools used for development and testing.
...
With just a few more lines of code, we can create a script that will be able to organize arbitrary number of windows, not only four of them.
...
we opted for 4 characters wide tabs in listings to save some horizontal space.
