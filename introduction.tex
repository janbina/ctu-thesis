...
They also come with stacking window managers, because those are controlled using a pointing device a thus easier for most users.
Among power users thought, lightweight desktops are more and more popular lately,
because they are light on system resources and thus fast.
This also leads to the increasing popularity of tiling window managers, since they are keyboard-oriented and targets at power users.
